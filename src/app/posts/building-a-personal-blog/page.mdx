...
<Image src={MyBlog} alt="My Blog" placeholder="blur" />
...
<Image src={DarkMode} alt="Dark Mode ALL THE THINGS!" placeholder="blur" />
...
<Image src={NowVsNetlify} alt="Now vs. Netlify" placeholder="blur" />
...
<Image src={Lighthouse} alt="lighthouse results" placeholder="blur" />
