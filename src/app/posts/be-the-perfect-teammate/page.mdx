...
<Image src={Listen} alt="You are what you listen to" placeholder="blur" />
Photo by [Mohammad Metri](https://unsplash.com/@mohammadmetri) on
...
<Image src={Teach} alt="2 people leaning over a computer" placeholder="blur" />
...
<Image
  src={Lift}
  alt="A cablecar going up a snowy mountain"
  placeholder="blur"
/>
Photo by [Stella Caraman](https://unsplash.com/@stellacaraman) on
[Unsplash](https://unsplash.com/)
...
<Image src={Text} alt="Paper with math excercises" placeholder="blur" />
Photo by [Chris Liverani](https://unsplash.com/@chrisliverani) on
[Unsplash](https://unsplash.com)
...
<Image src={Cover} alt="A graph going up" placeholder="blur" />
Photo by [Isaac Smith](https://unsplash.com/@isaacmsmith) on
[Unsplash](https://unsplash.com)
