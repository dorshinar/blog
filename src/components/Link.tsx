...
export function Link(props: ComponentPropsWithoutRef<typeof NextLink>) {
  return (
    <NextLink
      {...props}
      className={clsx(
        "text-emerald-500 underline underline-offset-4 shadow-[0_2px_0_0_theme(colors.emerald.500)] hover:shadow-[0_3px_0_0_theme(colors.emerald.500)] focus-visible:shadow-[0_3px_0_0_theme(colors.emerald.500)] transition-shadow",
