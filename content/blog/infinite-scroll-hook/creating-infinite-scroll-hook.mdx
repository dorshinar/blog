...
cover_image_credit: Photo by [Ryan Stone](https://unsplash.com/@rstone_design) on [Unsplash](https://unsplash.com/)
cover_image_alt: Infinity sign made by slow exposure and lights
published: true
---

import LazySimpleListContainer from "./LazySimpleListContainer.jsx";
import LazyListWithHooksContainer from "./LazyListWithHooksContainer.jsx";
import LazyColorShiftingBoxContainer from "./LazyColorShiftingBoxContainer.jsx";
...
<LazySimpleListContainer items={5} />
...
<LazyColorShiftingBoxContainer root />
...
<LazyColorShiftingBoxContainer root threshold={1} />

A threshold of 0.5 would trigger the callback when half of the element is visible.

<LazyColorShiftingBoxContainer root threshold={0.5} />
